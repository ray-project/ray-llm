...
Now you can create a RayCluster with RayLLM. RayLLM is included in the image `anyscale/ray-llm:latest`, which is specified in the RayCluster YAML manifest `ray-cluster.aviary-gke.yaml`.
